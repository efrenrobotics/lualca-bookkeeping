...
**Acquisition Site** — The public-facing surface. Goal: convert visitors into leads by booking a consultation or submitting a contact form. No authentication required. Fully bilingual: all pages available in English (`/en/`) and Spanish (`/es/`).
